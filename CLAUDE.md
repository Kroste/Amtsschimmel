...
- **Achievements:** 24 Stück (Klick-Achievements zählen nur manuelle Klicks), je +1 % Produktion, Toast-Benachrichtigung, verdeckt bis Freischaltung.
...
- **Meilensteine ("Beförderungen"):** ENDLICHE Reihe `[10, 25, 50, 100, 175, 250]` (`GameDefinitions.MilestoneThresholds`; per Spieler-Feedback v1.10.0 — der alte 100→250-Sprung war zu groß, endlose ×2-Folge langfristig balance-sprengend). Je Schwelle ×2, die **Endbeförderung bei 250 zählt ×3** (voll ausgebaut 2⁵×3 = 96, danach Schluss). Event `MilestoneReached` (auch bei Bulk-Käufen), Spezial-Toast + Achievement "Stellenplan erfüllt" bei 250, Karte zeigt "🎖️ Endbeförderung erreicht".
